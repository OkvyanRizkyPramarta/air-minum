...
<body>
    ...
    <div class="form-element-area">
        <div class="container">
        <form method="POST" action="{{ route('superadmin.table.watertank.update', $watertank->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        ...
                        <button class="btn btn-default btn-icon-notika col-md-2">
                            ...
                            <a href="{{ route('superadmin.table.watertank.index') }}" style="color:black;">BACK</a>
                        </button>
