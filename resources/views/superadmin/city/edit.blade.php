...
<body>
  ...
  <!-- Main Menu area End-->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <h2>Halaman Edit Data Kota/Kabupaten</h2>
    ...
    <div class="form-element-area">
        <div class="container">
        <form method="POST" action="{{ route('superadmin.table.city.update', $city->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="text" name="name" value="{{ $city->name}}" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <label>Luas Lautan (KM<sup>2</sup>)</label>
                                        <input type="number" name="ocean_area" value="{{ $city->ocean_area}}"  class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <label>Luas Daratan (KM<sup>2</sup>)</label>
                                        <input type="number" name="mainland_area" value="{{ $city->mainland_area}}"  class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <label>Total Luas (KM<sup>2</sup>)</label>
                                        <input type="number" name="total_area" value="{{ $city->total_area}}"  class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <!-- <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <label>OAP</label>
                                        <input type="number" name="oap" value="{{ $city->oap}}"  class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div> -->
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <label>Tahun</label>
                                        <input type="number" name="year" value="{{ $city->year}}"  class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-default btn-icon-notika col-md-2">
                            ...
                            <a href="{{ url('/superadmin/table/city/index') }}" style="color:black;">BACK</a>
                        </button>
