...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <h2>Halaman Tambah Data Kota/Kabupaten</h2>
    ...
    <div class="form-element-area">
        <div class="container">
        <form method="POST" action="{{ route('superadmin.table.city.store') }}" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="number" name="ocean_area" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="number" name="mainland_area" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="number" name="total_area" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
