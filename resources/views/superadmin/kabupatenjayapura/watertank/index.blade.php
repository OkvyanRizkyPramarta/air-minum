                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                                    ...
                                    <a href="{{url('/superadmin/airbersih/kabupaten/jayapura/watertank/create')}}" type="button" data-toggle="tooltip" style="background-color:white; color:black;" data-placement="left" class="btn"><b>Buat Data Baru</b></a>
                                </div>
							</div>
						</div>
					</div>
                                ...
                                @foreach($watertank as $w)
                                    <tr>
                                        ...
                                        <div class="row">
                                            <td class="text-center">
                                                <div class="col-lg-6">
                                                    <a href="{{ route('superadmin.airbersih.kabupatenjayapura.watertank.edit', $w->id) }}" class="btn notika-btn-black" style="color:white;"><i class="fa fa-edit"></i>
                                                        Edit
                                                    </a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <form action="{{ route('superadmin.airbersih.kabupatenjayapura.watertank.destroy', $w->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
