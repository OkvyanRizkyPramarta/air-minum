...
@section('content')
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <div class="breadcomb-wp">
                    <div class="breadcomb-ctn">
                      <h2>Halaman Tambah  Data Tabel Balai Wilayah Sungai BWS Intake Sungai</h2>
    ...
    <div class="form-element-area">
      <div class="container">
        <form method="POST" action="{{ route('superadmin.airbersih.kabupatenkepulauanyapen.municipalwaterwork.store') }}" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" style="padding-bottom:30px;">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="text" name="city_id" value="Kabupaten Biak Numfor" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" Disabled/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" style="padding-bottom:30px;">
