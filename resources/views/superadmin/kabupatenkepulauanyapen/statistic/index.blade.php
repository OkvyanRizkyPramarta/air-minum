						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                                    ...
                                    <a href="{{url('/superadmin/airbersih/kabupaten/kepulauanyapen/statistic/create')}}" type="button" data-toggle="tooltip" style="background-color:white; color:black;" data-placement="left" class="btn"><b>Buat Data Baru</b></a>
                                </div>
							</div>
						</div>
					</div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                @foreach($statistic as $s)
                                    <tr>
                                        ...
                                        <td class="text-center"><p><a href="{{ asset ('storage/'.$s->file)}}" target="_blank">{{ $s->name }}</a>.</p></td>
                                        ...
                                        <div class="row">
                                            <td class="text-center">
                                                <div class="col-lg-6">
                                                    <a href="{{ route('superadmin.airbersih.kabupatenkepulauanyapen.statistic.edit', $s->id) }}" class="btn notika-btn-black" style="color:white;"><i class="fa fa-edit"></i>
                                                        Edit
                                                    </a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <form action="{{ route('superadmin.airbersih.kabupatenkepulauanyapen.statistic.destroy', $s->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
