      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12" style="padding-top:30px;">
            <h1 class="banner_taital text-center" style="color:white;">Capaian Air Bersih Kabupaten Biak Numfor</h1>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <h3 class="text-center" style="color:#10597D;padding-top:150px;">
                    <span style=""><b>Data Balai Wilayah Sungai</b></span>
                  </h3>
                    <div class="data-table-list">
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tr>
                                  <td class="text-center"><p>{{ $r -> city -> name }}</p></td>
                                  <td class="text-center"><p>{{ $r -> district -> name }}</p></td>
                                  <td class="text-center"><p>{{ $r -> name }}.</p></td>
                                  <td class="text-center"><p><a href="{{ asset ('storage/'.$r->file)}}" target="_blank"><b>Detail</b></a></p></td>
                                </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
