            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <h3 class="text-center" style="color:#10597D;padding-top:150px;">
                    <span style=""><b>Data Badan Pengelolahan Dan Pendataan Daerah</b></span>
                  </h3>
                    <div class="data-table-list">
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tr>
                                  <td class="text-center"><p>{{ $d -> city -> name }}</p></td>
                                  <td class="text-center"><p>{{ $d -> name }}.</p></td>
                                  <td class="text-center"><p><a href="{{ asset ('storage/'.$d->file)}}" target="_blank"><b>Detail</b></a></p></td>
                                </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
