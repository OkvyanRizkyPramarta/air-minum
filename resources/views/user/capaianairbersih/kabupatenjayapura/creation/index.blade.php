                    ...
                    <div class="data-table-list">
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tr>
                                  <td class="text-center"><p>{{ $c -> city -> name }}</p></td>
                                  <td class="text-center"><p>{{ $c -> name }}.</p></td>
                                  <td class="text-center"><p><a href="{{ asset ('storage/'.$c->file)}}" target="_blank"><b>Detail</b></a></p></td>
                                </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
