						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                                    ...
                                    <a href="{{url('/subadmin/airbersih/kabupaten/keerom/waterresource/create')}}" type="button" data-toggle="tooltip" style="background-color:white; color:black;" data-placement="left" class="btn"><b>Buat Data Baru</b></a>
                                </div>
							</div>
						</div>
					</div>
                                ...
                                @foreach($waterresource as $w)
                                    <tr>
                                        ...
                                        <div class="row">
                                            <td class="text-center">
                                                <div class="col-lg-6">
                                                    <a href="{{ route('subadmin.airbersih.kabupatenkeerom.waterresource.edit', $w->id) }}" class="btn notika-btn-black" style="color:white;"><i class="fa fa-edit"></i>
                                                        Edit
                                                    </a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <form action="{{ route('subadmin.airbersih.kabupatenkeerom.waterresource.destroy', $w->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
