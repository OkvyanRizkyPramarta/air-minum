                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                                    ...
                                    <a href="{{url('/subadmin/airbersih/kabupaten/jayapura/creation/create')}}" type="button" data-toggle="tooltip" style="background-color:white; color:black;" data-placement="left" class="btn"><b>Buat Data Baru</b></a>
                                </div>
							</div>
						</div>
					</div>
                                ...
                                @foreach($creation as $c)
                                    <tr>
                                        ...
                                        <div class="row">
                                            <td class="text-center">
                                                <div class="col-lg-6">
                                                    <a href="{{ route('subadmin.airbersih.kabupatenjayapura.creation.edit', $c->id) }}" class="btn notika-btn-black" style="color:white;"><i class="fa fa-edit"></i>
                                                        Edit
                                                    </a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <form action="{{ route('subadmin.airbersih.kabupatenjayapura.creation.destroy', $c->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
