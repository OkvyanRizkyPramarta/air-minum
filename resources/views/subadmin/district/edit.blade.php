...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   ...
                   <h2>Halaman Edit Data Kecamatan</h2>
    ...
    <div class="form-element-area">
        <div class="container">
        <form method="POST" action="{{ route('subadmin.table.district.update', $district->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="text" name="name" value="{{ $district->name}}" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="number" name="postal_code" value="{{ $district->postal_code}}"  class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-default btn-icon-notika col-md-2">
                            ...
                            <a href="{{ url('/subadmin/table/district/index') }}" style="color:black;">BACK</a>
                        </button>
