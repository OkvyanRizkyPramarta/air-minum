...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <h2>Halaman Tambah Data Tampungan Air Baku</h2>
    ...
    <div class="form-element-area">
        <div class="container">
        <form method="POST" action="{{ route('subadmin.table.watertank.store') }}" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        ...
                        <button class="btn btn-default btn-icon-notika col-md-2">
                            ...
                            <a href="{{ url('/subadmin/table/watertank/index') }}" style="color:black;">BACK</a>
                        </button>
