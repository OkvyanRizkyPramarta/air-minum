...
<body>
  ...
  <!-- Main Menu area End-->
    ...
    <div class="form-element-area">
        <div class="container">
        <form method="POST" action="{{ route('subadmin.table.map.update', $map->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <label>Nama Kota</label>
                                        <div class="bootstrap-select fm-cmp-mg">
                                            <select class="selectpicker" value="{{ $map->city->name }}" name="city_id" data-live-search="true">
                                                @foreach($city as $c)  
                                                  <option value="{{ $c->id }}" {{ ($c->id == $map->city->id) ? 'selected' : ''}} >
                                                   {{ $c->name }}
                                                  </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <input type="text" name="name" value="{{ $map->name }}" class="form-control" required="required" data-validation-required-message="Silahkan Masukkan Data" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <label>Gambar</label>
                                        <input type="file" name="image" value="{{ $map->image }}" class="form-control" data-validation-required-message="Silahkan Masukkan Data" >
                                        <img src="{{ asset ('storage/'.$map->image)}}" width="150px;"></img>
                                    </div>
                                </div>
                            </div>
                        </div>
